const textConfig = {
  landing: {
    title: "Happy Birthday, Iiiisshhaaaaaa!💕 🎂✨",
  ...
  letter: {
    ...
    letterHeaderTitle: "To My Cocuuu",
...
Happy Birthday, my love! Here's to another year of adventures together 💕`,
  ...
  cards: {
    ...
    cardMessages: [
      "💫 I still remember the way you hugged me, and how everything felt right for a while.,Happy Birthday to the girl who makes every day feel like a celebration! 🎉💕",
      "❤️ “I still remember that moment — the sweetness of the chocolate and the sweetness of you, both together.”Another year of being absolutely incredible, beautiful, and perfect just the way you are! ✨",
      "❤️ “I still remember how our feet touched in the bus, and suddenly everything around us disappeared.”May this new year bring you endless joy, love, and all the dreams your heart desires! 🌟💖"
    ]
  },
  ...
  finalLetter: {
    ...
    letterParagraphs: [
       "My love, today isn’t just your birthday — it’s the celebration of the girl who changed my world in the softest, sweetest ways.",
    "I still remember the way you put a smile on my face without even trying…",
    "I still remember the way you looked into my eyes like you could read my soul.",
    "I still remember the way you held my hand like you never wanted to let go.",
    "I still remember the way your laughter made everything around me feel lighter.",
    "I still remember the way you blush whenever I tease you softly.",
    "Every little memory with you is carved in my heart forever.",
    "You are the one who makes my ordinary days feel special. You are the one who brings warmth to my heart even when the world feels cold.",
